      ...
      <aside className="hidden lg:flex fixed top-0 bottom-0 left-0 z-30 w-64 flex-col justify-between border-r border-zinc-200 bg-white p-5 shadow-sm">
        <div className="space-y-6">
          ...
          <Link href="/dashboard" className="flex items-center gap-2 group">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-linear-to-tr from-red-600 to-red-800 shadow-sm group-hover:shadow-red-200 transition-shadow">
        ...
        <div className="border-t border-zinc-150 pt-4 space-y-4">
          ...
          <form action={handleLogout}>
            <Button type="submit" variant="ghost" className="w-full flex items-center justify-center gap-2 text-xs font-bold text-zinc-650">
