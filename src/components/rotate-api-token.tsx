  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-white text-sm font-semibold disabled:opacity-50 transition-all"
      >
      ...
      {token && (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleCopy}
              className="shrink-0 flex items-center justify-center h-8 w-8 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white transition-all"
            >
